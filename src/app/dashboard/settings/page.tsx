          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-600 text-sm">$39.99/month</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {businesses.length === 0 ? (
              ...
              businesses.map((business) => (
                <div
                  key={business.id}
                  className="flex justify-between items-center p-4 bg-slate-50 rounded-lg border border-slate-200 hover:bg-slate-100 transition-colors"
                >
                  <div className="flex-1">
                    <p className="font-medium text-slate-900">{business.name}</p>
                    <p className="text-xs text-slate-500 mt-1">
                      {business.platform_connections?.google ? '✓ Google connected' : 'No integrations'}
                    </p>
                  </div>
                  <button
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
              <p className="text-sm text-slate-600 font-medium">Subscription Status</p>
              <p className="text-lg font-bold text-green-600 mt-1">Active</p>
            </div>

            <button
              onClick={() => setShowCancelConfirm(true)}
              className="w-full px-4 py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-colors mt-6"
            >
              Cancel Plan
            </button>
          </div>
      ...
      {showCancelConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-4">
            ...
            <p className="text-slate-600 mb-6">
              Are you sure you want to cancel your ReviewHub Pro subscription? This action cannot be undone.
            </p>
