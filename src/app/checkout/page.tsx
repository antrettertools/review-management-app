        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-7">
            ...
            <p className="text-sm text-slate-500">
              {signupData?.billing === 'annual' ? '14 days free, then $200/year' : '14 days free, then $19.99/month'}
            </p>
          </div>
            ...
            <div className="bg-blue-800 p-6 text-center">
              ...
              {signupData?.billing === 'annual' ? (
                <>
                  ...
                  <p className="text-blue-200/80 text-sm mt-1">Billed as $200/year after free trial</p>
                </>
              ) : (
                <>
                  <div className="flex items-baseline justify-center gap-1">
